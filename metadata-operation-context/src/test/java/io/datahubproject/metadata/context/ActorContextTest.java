...
public class ActorContextTest {
  ...
  @Test
  public void isSystemSessionMatchesSystemActorContext() {
    Authentication systemAuth =
        new Authentication(new Actor(ActorType.USER, "__datahub_system"), "");
    Authentication userAuth = new Authentication(new Actor(ActorType.USER, "user"), "");
    ActorContext systemContext = ActorContext.asSystem(systemAuth, true);

    assertTrue(ActorContext.isSystemSession(systemAuth, systemContext));
    assertFalse(ActorContext.isSystemSession(userAuth, systemContext));
