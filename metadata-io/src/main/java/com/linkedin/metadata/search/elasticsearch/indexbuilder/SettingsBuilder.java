...
public class SettingsBuilder {
  ...
  public static final String MULTIFILTER_GRAPH_2 = DEFAULT_SYN_GRAPH;
  public static final String MULTIFILTER_GRAPH_3 = String.join(",", ALPHA_ONLY, DEFAULT_SYN_GRAPH);
